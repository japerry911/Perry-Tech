...
const Header = ({ value, setValue }) => {
  ...
  const routes = [
    ...
    { name: "Store", link: "/store", activeIndex: 2 },
    { name: "Contact", link: "/contact", activeIndex: 3 },
    { name: "Sign In", link: "/sign-in", activeIndex: 4 },
    { name: "Sign Up", link: "/sign-up", activeIndex: 5 },
  ];
          ...
          <Toolbar disableGutters>
            ...
            >
              <img
                ...
                src="https://perry-tech-12312943924932.s3.us-east-2.amazonaws.com/Logos/white_logo_transparent_background.png"
              />
            </Button>
